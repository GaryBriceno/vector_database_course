...
chatgpt_model = ChatOpenAI(model=MODEL_NAME,
...
groq_model = ChatGroq(model=MODEL_NAME, api_key=os.getenv('GROQ_API_KEY'))

# %% Basic Example
res = chatgpt_model.invoke("What is a LangChain?")
# %%
...
# %%
res = chatgpt_model.invoke("What are the limitations of Large-Language-Models?")
# %%
pprint(res.content, width=50)
...
prompt = ChatPromptTemplate.from_messages(messages)
chain = prompt | chatgpt_model | StrOutputParser()
