...
create_qa = Task(
    ...
    expected_output = ("Question and corresponding answers, "
                       ...
                       "Possible Answers: 'A: Paris', 'B: London', 'C: Berlin', 'D: Madrid'\n"
                       "Rationale: A (correct) because ..., B (incorrect) because ..., C (incorrect) because ..., D (incorrect) because ..."
                       "Choose randomly which answer is correct")
)
# %% Set up the crew
crew = Crew(
